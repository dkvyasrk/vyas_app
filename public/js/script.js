...
const getWeather = async (city) => {
    try {
        ...
        if (id < 300 && id > 200) {
            tempicon.src = "./pic/thunderstorm.svg"
        }
        else if (id < 400 && id > 300) {
            tempicon.src = "./pic/cloud-solid.svg"
        }
        else if (id < 600 && id > 500) {
            tempicon.src = "./pic/rain.svg"
        }
        else if (id < 700 && id > 600) {
            tempicon.src = "./pic/snow.svg"
        }
        else if (id < 800 && id > 700) {
            tempicon.src = "./pic/cloud.svg"
        }
        else if (id == 800) {
            tempicon.src = "./pic/clouds-and-sun.svg"
        }
